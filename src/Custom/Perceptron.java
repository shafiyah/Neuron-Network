...
public class Perceptron {
    ...
    public List datas;
    public List dataTesting;
    public double[] weight;
    public int Threshold;

    public Perceptron() {
        this.datas = new ArrayList();
        this.dataTesting = new ArrayList();
    ...
    public Data getDataTesting(int i) {
        return (Data) this.dataTesting.get(i);
    }
    
    public void addDataTesting(Data dataTesting) {
        this.dataTesting.add(dataTesting);
    }

    public void DataTesting(List dataTesting) {
